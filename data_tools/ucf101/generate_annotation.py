...
def main():
    ...
    train_lst_path = osp.join(os.getcwd(), '{}/ucf101_train_split_1_videos.txt'.format(data_root))
    val_lst_path = osp.join(os.getcwd(), '{}/ucf101_val_split_1_videos.txt'.format(data_root))
