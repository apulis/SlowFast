...
def main():
    ...
    '''
    hmdb51_root = 'data/hmdb51'
    train_lst_path = osp.join(os.getcwd(), '{}/hmdb51_train_split_1_videos.txt'.format(hmdb51_root))
    val_lst_path = osp.join(os.getcwd(), '{}/hmdb51_val_split_1_videos.txt'.format(hmdb51_root))
